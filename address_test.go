...
func TestAddress_NewAddress(t *testing.T) {
	tests := []struct {
		...
		{
			addr: &Address{
				Source:   "143300, Московская область, г. Наро-Фоминск, ул. Полубоярова, стр. 8, этажи 4, 5",
				Region:   "Московская область",
				Zip:      "143300",
				Street:   "г. Наро-Фоминск, ул. Полубоярова",
				Building: "8",
			},
			wantErr: false,
		},
		{
			addr: &Address{
				Source: "107076, г. Москва, ул.2-я Бухвостова, вл. 4, номер зала судебных заседаний: 406",
				Zip:    "107076",
				Street: "г. Москва, ул. 2-я Бухвостова, вл",
				House:  "4номерзаласудебныхзаседаний:406",
			},
			wantErr: false,
		},
		{
		...
		},
		{
			addr: &Address{
				...
				Street: "Курчалоевский р-н, Курчалой, ул. А.А.Кадырова, б/н",
			},
			wantErr: false,
		},
		{
		...
		{
			addr: &Address{
				Source:   "629303, ЯНАО, г. Новый Уренгой, мкрн. Советский, дом 9, стр. 1, к. А",
				Zip:      "629303",
				Region:   "ЯНАО",
